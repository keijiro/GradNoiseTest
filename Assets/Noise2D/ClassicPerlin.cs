...
public static class ClassicPerlin
{
    ...
    public static float GetAt(float x, float y)
    {
        ...
        var g1 = Grad(perm[A    ], x    , y    );
        var g2 = Grad(perm[B    ], x - 1, y    );
        var g3 = Grad(perm[A + 1], x    , y - 1);
        var g4 = Grad(perm[B + 1], x - 1, y - 1);
        return Mathf.Lerp(Mathf.Lerp(g1, g2, u), Mathf.Lerp(g3, g4, u), v);
    }
